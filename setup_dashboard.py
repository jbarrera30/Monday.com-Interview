...
def main():
    ...
    print('     Active (3) · Complete (1) · On hold (1) · Not started (1)')
    print()
    print('  Demo talking point:')
    print('  "Three engagements active, one on hold — that\'s Retail Plus,')
    ...
    print('     Done (11) · To do (11) · In progress (4) · In review (1)')
    print()
    print('  Demo talking point:')
    ...
    print('  4. Add filter → Status = Active')
    print('  5. Expected value: $425,000')
    print('     (ENG-001 $150k + ENG-002 $200k + ENG-003 $75k)')
    print()
    print('  Demo talking point:')
    print('  "$425K in active billings across three engagements."')
    print()
